...
if __name__ == '__main__':
    datapath = 'D:/PythonProjects_Data/AMIGO/Step4_Split/Vector00/'
    labelpath = 'D:/PythonProjects_Data/AMIGO/Step5_LabelCopy/'
    savepath = 'D:/PythonProjects_Data/AMIGO/Step6_FinalNpy/Vector00/'
    ...
    for foldname in os.listdir(datapath):
        ...
        for sampleIndex in range(20):
            labelData = numpy.genfromtxt(
                fname=os.path.join(labelpath, foldname, 'Sample%02d-Label.csv' % sampleIndex), dtype=int, delimiter=',')
